...
| <a id="bool_flag-scope"></a>scope |  The scope indicates where a flag can propagate to.<br><br>Possible values: * `"universal"` - the flag will propagate everywhere in the build graph. * `"project"`- the flag will propagate within the project boundaries that are defined by project owners in their PROJECT.scl file. * `"exec"` - the flag will propagate to the exec configuration.   | String | optional |  `"universal"`  |
...
| <a id="bool_setting-scope"></a>scope |  The scope indicates where a flag can propagate to.<br><br>Possible values: * `"universal"` - the flag will propagate everywhere in the build graph. * `"project"`- the flag will propagate within the project boundaries that are defined by project owners in their PROJECT.scl file. * `"exec"` - the flag will propagate to the exec configuration.   | String | optional |  `"universal"`  |
...
| <a id="int_flag-scope"></a>scope |  The scope indicates where a flag can propagate to.<br><br>Possible values: * `"universal"` - the flag will propagate everywhere in the build graph. * `"project"`- the flag will propagate within the project boundaries that are defined by project owners in their PROJECT.scl file. * `"exec"` - the flag will propagate to the exec configuration.   | String | optional |  `"universal"`  |
...
| <a id="int_setting-scope"></a>scope |  The scope indicates where a flag can propagate to.<br><br>Possible values: * `"universal"` - the flag will propagate everywhere in the build graph. * `"project"`- the flag will propagate within the project boundaries that are defined by project owners in their PROJECT.scl file. * `"exec"` - the flag will propagate to the exec configuration.   | String | optional |  `"universal"`  |
...
| <a id="string_flag-scope"></a>scope |  The scope indicates where a flag can propagate to.<br><br>Possible values: * `"universal"` - the flag will propagate everywhere in the build graph. * `"project"`- the flag will propagate within the project boundaries that are defined by project owners in their PROJECT.scl file. * `"exec"` - the flag will propagate to the exec configuration.   | String | optional |  `"universal"`  |
...
| <a id="string_list_flag-scope"></a>scope |  The scope indicates where a flag can propagate to.<br><br>Possible values: * `"universal"` - the flag will propagate everywhere in the build graph. * `"project"`- the flag will propagate within the project boundaries that are defined by project owners in their PROJECT.scl file. * `"exec"` - the flag will propagate to the exec configuration.   | String | optional |  `"universal"`  |
...
| <a id="string_list_setting-scope"></a>scope |  The scope indicates where a flag can propagate to.<br><br>Possible values: * `"universal"` - the flag will propagate everywhere in the build graph. * `"project"`- the flag will propagate within the project boundaries that are defined by project owners in their PROJECT.scl file. * `"exec"` - the flag will propagate to the exec configuration.   | String | optional |  `"universal"`  |
...
| <a id="string_setting-scope"></a>scope |  The scope indicates where a flag can propagate to.<br><br>Possible values: * `"universal"` - the flag will propagate everywhere in the build graph. * `"project"`- the flag will propagate within the project boundaries that are defined by project owners in their PROJECT.scl file. * `"exec"` - the flag will propagate to the exec configuration.   | String | optional |  `"universal"`  |
